...
static void Keyboard_UpdateReport(void){
   ...
   if( !digitalRead( TEC1 ) ){
      HID_KEYBOARD_REPORT_SET_KEY_PRESS(g_keyBoard.report, 0x12); /* 'o' */
   }
   else if( !digitalRead( TEC2 ) ){
      HID_KEYBOARD_REPORT_SET_KEY_PRESS(g_keyBoard.report, 0x13); /* 'p' */
   }
   else if( !digitalRead( TEC3 ) ){
      HID_KEYBOARD_REPORT_SET_KEY_PRESS(g_keyBoard.report, 0x14); /* 'q' */
   }
   else if( !digitalRead( TEC4 ) ){
      HID_KEYBOARD_REPORT_SET_KEY_PRESS(g_keyBoard.report, 0x15); /* 'r' */
   }
